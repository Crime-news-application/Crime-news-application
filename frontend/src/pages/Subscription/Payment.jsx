...
//     "AbHh_AJVmvukrNF3D_ZA-aX9OHToeHnJt-SNX8XnFrulXN-sjsLu1yzpk0vZRkceQv8gOnSyuz-xNss6";
...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return <h2 className="text-red-600">حدث خطأ أثناء تحميل معالج الدفع. يرجى المحاولة لاحقاً.</h2>;
    }
    return this.props.children;
  }
}
...
const PaymentPage = () => {
  ...
  // تعريف ألوان مخصصة حسب تصميمك - تم تحسين ألوان النص للرؤية
  const customColors = {
    primary: "#61090b",
    dark: "#000000",
    text: "#333333", // تم تغيير لون النص الافتراضي من #ffffff إلى لون داكن
    lightGray: "#f3f4f6",
    mediumGray: "#9ca3af",
    darkGray: "#1f2937",
  };
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            {loggedInUser && loggedInUser.name ? (
              <p className="text-gray-700"> {/* تم تغيير من text-gray-600 إلى text-gray-700 */}
                {loggedInUser.name} ({loggedInUser.email})
              </p>
            ) : (
              <p className="text-gray-700"> {/* تم تغيير من text-gray-600 إلى text-gray-700 */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between">
                    <span className="font-medium text-gray-800">Plan:</span> {/* تم إضافة text-gray-800 */}
                    <span className="text-gray-800">{title}</span> {/* تم إضافة text-gray-800 */}
                  </div>
                  <div className="flex justify-between">
                    <span className="font-medium text-gray-800">Price:</span> {/* تم إضافة text-gray-800 */}
                    <span className="text-gray-800">{price}</span> {/* تم إضافة text-gray-800 */}
                  </div>
                  <div className="flex justify-between">
                    <span className="font-medium text-gray-800">Duration:</span> {/* تم إضافة text-gray-800 */}
                    <span className="text-gray-800">{duration}</span> {/* تم إضافة text-gray-800 */}
                  </div>
                  <div>
                    <span className="font-medium text-gray-800">Features:</span> {/* تم إضافة text-gray-800 */}
                    <ul className="mt-2">
                      {features && features.length > 0 ? (
                        features.map((feature, index) => (
                          <li key={index} className="flex items-center">
                            ...
                            <span className="text-gray-800">{feature}</span> {/* تم إضافة text-gray-800 */}
                          </li>
                        ))
                      ) : (
                        <li className="text-gray-500">No features available.</li>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div className="mb-6">
                  <div className="flex items-center space-x-4 mb-4">
                    <input
                      ...
                      style={{ accentColor: customColors.primary }}
                    />
                    <label htmlFor="paypal" className="flex items-center text-gray-800"> {/* تم إضافة text-gray-800 */}
                      <span className="mr-2">PayPal</span>
                      <img src="/api/placeholder/120/40" alt="PayPal" className="h-8" />
                    </label>
                  </div>
                  <div className="flex items-center space-x-4 mb-4">
                    <input
                      ...
                      style={{ accentColor: customColors.primary }}
                    />
                    <label htmlFor="credit-card" className="flex items-center text-gray-800"> {/* تم إضافة text-gray-800 */}
                      <span className="mr-2">Credit Card</span>
                      <img src="/api/placeholder/120/40" alt="Credit Cards" className="h-8" />
                    </label>
                  </div>
                  ...
                  <div className="border-2 border-gray-300 rounded-lg p-5 bg-white">
                    <div className="grid grid-cols-1 gap-4">
                      <div>
                        ...
                        <input
                          type="text"
                          className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2  text-gray-700"
                          style={{ borderColor: customColors.primary }}
                          placeholder="0000 0000 0000 0000"
                        />
                      </div>
                ...
                <div className="mt-6 text-sm text-gray-700 flex items-center"> {/* تم تغيير من text-gray-600 إلى text-gray-700 */}
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
                    <path
                      fillRule="evenodd"
                      d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z"
